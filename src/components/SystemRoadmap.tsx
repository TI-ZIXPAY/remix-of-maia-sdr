        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/20 rounded-lg p-6">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                <h4 className="text-white font-bold">Configurações Obrigatórias Após Remix</h4>
                <p className="text-slate-300 text-sm mt-1">
                  Após remixar este projeto, execute estas configurações para garantir o funcionamento completo.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">Webhooks externos precisam de autenticação desabilitada</p>
              </div>
            </div>
            
            <div className="ml-14 space-y-3">
              <p className="text-slate-300 text-sm">No Supabase Dashboard, edite cada função abaixo e desabilite "Verify JWT":</p>
...
• trigger-whatsapp-sender`}
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-3">
                <p className="text-cyan-200 text-xs flex items-center gap-2">
                  <Info className="w-4 h-4" />
                  Sem esta configuração, os webhooks do WhatsApp não funcionarão corretamente.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">Conecte seu número do WhatsApp ao novo projeto</p>
              </div>
            </div>
            
            <div className="ml-14 space-y-3">
              <div className="space-y-2 text-sm text-slate-300">
                <p>1. Acesse <a href="https://developers.facebook.com" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">developers.facebook.com</a></p>
                <p>2. Vá em seu App → WhatsApp → Configuração</p>
                <p>3. Em "Webhook", configure:</p>
              </div>
              <div className="bg-slate-950 border border-slate-700 rounded-lg p-4 space-y-2">
                <p className="text-xs text-slate-400">URL do Callback:</p>
                <code className="text-xs text-emerald-400 font-mono break-all">
                  https://SEU_PROJECT_ID.supabase.co/functions/v1/whatsapp-webhook
                </code>
                <p className="text-xs text-slate-400 mt-3">Verify Token:</p>
                <code className="text-xs text-emerald-400 font-mono">
                  (configurado em Configurações → APIs)
                </code>
              </div>
              <p className="text-slate-400 text-xs">4. Marque os campos: <code className="bg-slate-800 px-1 rounded">messages</code> e <code className="bg-slate-800 px-1 rounded">message_status</code></p>
            </div>
          </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-slate-600 flex items-center justify-center text-white font-bold text-lg flex-shrink-0">3</div>
              <div>
                <h4 className="text-white font-bold text-lg">ElevenLabs API Key (Opcional)</h4>
                <p className="text-slate-400 text-sm">Para respostas em áudio via TTS</p>
              </div>
            </div>
            
            <div className="ml-14 space-y-3">
              <p className="text-slate-300 text-sm">Se quiser habilitar respostas em áudio:</p>
              <div className="space-y-2 text-sm text-slate-400">
                <p>1. Crie conta em <a href="https://elevenlabs.io" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">elevenlabs.io</a></p>
                <p>2. Gere uma API Key no painel</p>
                <p>3. Configure em Configurações → APIs → ElevenLabs</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-4">
            <div className="flex items-start gap-2">
              ...
              <div>
                <p className="text-emerald-200 text-sm font-medium">Após completar o checklist</p>
                <p className="text-emerald-200/70 text-sm mt-1">
                  Seu projeto remixado estará 100% funcional. Execute o wizard de onboarding para configurar 
                  suas credenciais específicas (WhatsApp, prompt do agente, etc).
                </p>
              </div>
            </div>
          </div>
      ...
      content: (
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/20 rounded-lg p-6">
            ...
            <p className="text-slate-300 text-sm leading-relaxed">
              Após remixar o projeto, algumas configurações manuais são necessárias para que o sistema funcione corretamente.
              As migrations de banco de dados (Realtime, Triggers, RLS) são aplicadas automaticamente.
            </p>
          </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-amber-500 flex items-center justify-center text-white font-bold text-lg flex-shrink-0">1</div>
              <div>
                <h4 className="text-white font-bold text-lg">Configurar Edge Functions (verify_jwt = false)</h4>
                <p className="text-slate-400 text-sm">Necessário para webhooks e funções públicas</p>
              </div>
            </div>
            
            <div className="space-y-4 ml-14">
              <p className="text-slate-300 text-sm">
                As seguintes Edge Functions precisam ter <code className="text-amber-400">verify_jwt = false</code> no arquivo <code className="text-cyan-400">supabase/config.toml</code>:
              </p>
              
              <div className="bg-slate-950 border border-slate-700 rounded-lg p-4">
                <p className="text-xs text-slate-400 mb-2">Funções que requerem acesso público:</p>
              ...
              <div className="bg-slate-950 border border-slate-700 rounded-lg p-4">
                <p className="text-xs text-slate-400 mb-2">Exemplo de configuração no config.toml:</p>
...
verify_jwt = false`}
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-amber-500 flex items-center justify-center text-white font-bold text-lg flex-shrink-0">2</div>
              <div>
                <h4 className="text-white font-bold text-lg">Configurar Webhook no Meta for Developers</h4>
                <p className="text-slate-400 text-sm">Conectar o WhatsApp ao novo projeto</p>
              </div>
            </div>
            ...
            <div className="space-y-4 ml-14">
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-slate-300">Acesse o <a href="https://developers.facebook.com" target="_blank" rel="noopener noreferrer" className="text-cyan-400 underline">Meta for Developers</a> e selecione seu app</p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-amber-400 font-bold">2.2</span>
                  <p className="text-slate-300">Vá em <strong className="text-white">WhatsApp → Configuration</strong></p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-amber-400 font-bold">2.3</span>
                  <p className="text-slate-300">Atualize a <strong className="text-white">Webhook URL</strong> com a nova URL do projeto remixado</p>
                </div>
                
                <div className="flex items-start gap-3">
                  <span className="text-amber-400 font-bold">2.4</span>
                  <p className="text-slate-300">Use o mesmo <strong className="text-white">Verify Token</strong> configurado em Configurações → APIs</p>
                </div>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
                <div className="flex items-start gap-2">
                  <AlertTriangle className="w-5 h-5 text-amber-400 flex-shrink-0 mt-0.5" />
                  <p className="text-amber-200 text-sm">
                    <strong>Importante:</strong> O Webhook URL muda com cada remix. Sempre atualize no Meta for Developers.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-10 h-10 rounded-full bg-slate-600 flex items-center justify-center text-white font-bold text-lg flex-shrink-0">3</div>
              <div>
                <h4 className="text-white font-bold text-lg">Configurar ElevenLabs API (Opcional)</h4>
                <p className="text-slate-400 text-sm">Para respostas em áudio</p>
              </div>
            </div>
            
            <div className="space-y-4 ml-14">
              <p className="text-slate-300 text-sm">
                Se você deseja que a Nina responda com áudio, configure sua API key do ElevenLabs em <strong className="text-white">Configurações → APIs → ElevenLabs</strong>.
              </p>
              
              <div className="bg-slate-800 rounded-lg p-4 border border-slate-700">
                <p className="text-xs text-slate-400 flex items-center gap-2">
                  <Info className="w-4 h-4 text-cyan-400" />
                  Esta configuração é opcional. Sem ela, a Nina responderá apenas com texto.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-emerald-900/20 border border-emerald-700/50 rounded-lg p-4">
            <p className="text-sm text-emerald-200 flex items-start gap-2">
              <CheckCircle2 className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" />
              <span>
                <strong>Migrations Automáticas:</strong> As seguintes configurações são aplicadas automaticamente pelo sistema pós-remix:
                <br />• Realtime habilitado para todas as tabelas principais
                <br />• Triggers de automação (auto_create_deal, update_last_message, updated_at)
                <br />• Políticas RLS single-tenant para deals e appointments
                <br />• Fallback de polling quando Realtime falhar
              </span>
            </p>
          </div>
        </div>
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
            <p className="text-yellow-400 font-medium mb-2">⚠️ Após remixar o projeto, verifique os itens abaixo:</p>
          </div>

          <div className="space-y-3">
            <div className="bg-slate-800/50 rounded-lg p-4">
              <h4 className="text-cyan-400 font-medium mb-2">1. Edge Functions - verify_jwt = false</h4>
              <p className="text-slate-400 text-sm mb-2">Configure <code className="text-cyan-300">verify_jwt = false</code> no <code className="text-cyan-300">supabase/config.toml</code> para estas funções:</p>
              <div className="bg-slate-900 rounded p-3 text-xs text-slate-300 font-mono">
                whatsapp-webhook, uazapi-webhook, message-grouper, nina-orchestrator, whatsapp-sender, uazapi-sender, initialize-system, validate-setup, simulate-webhook, simulate-audio-webhook, test-whatsapp-message, test-elevenlabs-tts, generate-prompt, analyze-conversation, health-check, seed-appointments, trigger-nina-orchestrator, trigger-whatsapp-sender
              </div>
            </div>

            <div className="bg-slate-800/50 rounded-lg p-4">
              <h4 className="text-cyan-400 font-medium mb-2">2. Webhook no Meta for Developers</h4>
              <p className="text-slate-400 text-sm">Configure a URL do webhook no painel do Meta:</p>
              <div className="bg-slate-900 rounded p-3 text-xs text-slate-300 font-mono mt-2">
                URL: https://[PROJECT_ID].supabase.co/functions/v1/whatsapp-webhook<br/>
                Verify Token: (definido em nina_settings.whatsapp_verify_token)
              </div>
            </div>

            <div className="bg-slate-800/50 rounded-lg p-4">
              <h4 className="text-cyan-400 font-medium mb-2">3. Webhook Uazapi (se aplicável)</h4>
              <p className="text-slate-400 text-sm">Configure a URL do webhook no painel Uazapi:</p>
              <div className="bg-slate-900 rounded p-3 text-xs text-slate-300 font-mono mt-2">
                URL: https://[PROJECT_ID].supabase.co/functions/v1/uazapi-webhook
              </div>
            </div>

            <div className="bg-slate-800/50 rounded-lg p-4">
              <h4 className="text-cyan-400 font-medium mb-2">4. ElevenLabs API Key (opcional)</h4>
              <p className="text-slate-400 text-sm">Se quiser respostas em áudio, configure a API key da ElevenLabs nas configurações de APIs.</p>
            </div>

            <div className="bg-slate-800/50 rounded-lg p-4">
              <h4 className="text-cyan-400 font-medium mb-2">5. Migrations automáticas (já aplicadas)</h4>
              <p className="text-slate-400 text-sm">As seguintes configurações são aplicadas automaticamente no remix:</p>
              <ul className="text-slate-400 text-sm mt-2 space-y-1 list-disc list-inside">
                <li>Realtime habilitado para tabelas principais</li>
                <li>Triggers de auto-criação de deals e atualização de timestamps</li>
                <li>Políticas RLS single-tenant para deals e appointments</li>
                <li>Fallback de polling quando Realtime falhar</li>
              </ul>
            </div>
          </div>
        </div>
