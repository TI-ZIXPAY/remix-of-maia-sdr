...
const Logo = () => {
  return (
    <Link to="/dashboard" className="flex items-center py-1 px-1">
      <img src={saLogo} alt="SA" className="h-8 object-contain" />
    </Link>
  );
};
  ...
  return (
    <Link to="/dashboard" className="flex items-center py-1">
      <div className="relative w-10 h-10 flex items-center justify-center flex-shrink-0">
        ...
        <div className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-accent flex items-center justify-center shadow-lg shadow-primary/20 overflow-hidden p-1">
          <img src={saLogo} alt="SA" className="w-full h-full object-contain" />
        </div>
      </div>
    </Link>
  );
