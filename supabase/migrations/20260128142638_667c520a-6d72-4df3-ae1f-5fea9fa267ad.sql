-- =============================================
-- MIGRATION 3: Update RLS Policies for Single-Tenant
-- =============================================

-- Update deals policy - shared access for all authenticated users
...
-- Update appointments policy - shared access for all authenticated users
